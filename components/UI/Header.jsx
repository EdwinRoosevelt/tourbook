				...
				<div className="container-fluid d-flex wrap gap-4 p-2 justify-content-between align-items-center">
					...
					<div className="d-flex mx-sm-4 gap-3 justify-content-between align-items-center">
						{tourbookUser && (
							<>
								<button
									className="btn btn-outlint-dark p-2"
									type="button"
									onClick={() => {
								...
								<button
									...
									className="btn d-flex align-items-center gap-2 text-start p-2"
									type="button"
									style={{ borderRadius: "200px" }}
									onClick={() => {
								...
								>
										...
										<div className="row g-0">
											...
											<div className="col-md-8 col-9">
												<div className="card-body">
													<h5 className="card-title fs-3">{tourbookUser.displayName}</h5>
									...
									<ul className="fs-6 py-3">
										...
										<li>
											<Link href={`/profile/${encodeURIComponent(tourbookUser.userName)}`}>
												<a className="dropdown-item flex align-items-center gap-4 mb-2 p-2">
													<UserCircle size="30" />
													<p>Profile</p>
												</a>
